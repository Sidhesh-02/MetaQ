...
export default function About() {
  return (
    <section className="relative overflow-hidden py-28 px-6 md:px-16 bg-white transition-colors duration-500">
      ...
      <div className="max-w-4xl mx-auto relative z-10 text-center space-y-8">
        ...
        {/* CTA */}
        <a className="cursor-pointer mt-6 px-8 py-3 rounded-full border border-gray-300 text-zinc-900 bg-white hover:bg-purple-50 transition font-medium">
          Connect →
        </a>
      </div>
    </section>
